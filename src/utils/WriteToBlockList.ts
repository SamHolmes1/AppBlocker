...
const WriteToBlockList = (inputName: string, inputURL: string = `${inputName.toLowerCase()}.com`, inputLogoUrl: string = `https://${inputURL}/favicon.ico`, blocked: boolean = false) => {
